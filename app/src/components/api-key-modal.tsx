...
export const ApiKeyModal: FC<{ open: boolean, close: () => void }> = ({
  open,
  close
}) => {
    ...
    >
      {loading ? (
        ...
        <>
          ...
          <Btn outlined className='mt-4' onClick={done}>
            Got it
          </Btn>
        </>
      ) : (
        <>
          ...
          <Btn
            outlined
            type='button'
            className='block w-48 mx-auto mt-5 mb-3'
            onClick={run}
          >
            Yes, do it
          </Btn>
          <Btn type='button' className='block w-48 mx-auto' onClick={close}>
            Never mind
          </Btn>
        </>
      )}
