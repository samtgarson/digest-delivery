...
export const ArticleItem: FC<ArticleItemProps> = ({ data: { title, author, source, originalUrl } }) => {
  return <li className="mb-8 relative">
    ...
    { originalUrl && <Link passHref href={originalUrl}>
      <Anchor target="_blank" naked small className="px-3 absolute right-0 top-6 transform -translate-y-2/4 h-12 bg-green">
        <LinkIcon />
