...
export const NextDigestItem: FC<{ count: number, delivery: Date, active: boolean }> = ({ count, delivery, active }) => <div className="list-none bg-whiteFade">
  <Link href={'/digests/next'}><Anchor aria-label="View your next digest" naked small className="flex items-center p-3 w-full">
    ...
    <div>
      <p className="font-bold">{ active ? titleize(relativeDate(delivery)) : 'Not scheduled for delivery' }</p>
