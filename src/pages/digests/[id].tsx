...
const DigestShow: NextPage<{ digest: DigestEntityWithArticles }> = ({ digest }) => {
  return <PageWrapper title={`Digest ${humaniseDate(digest.deliveredAt)}`}>
    <div className="flex mt-6">
      <img src={`https://assets.digest.delivery/cover-${dateString(digest.deliveredAt)}.png`} className="h-48 mr-5 mb-5 rounded" />
