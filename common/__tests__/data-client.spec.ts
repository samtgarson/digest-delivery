...
describe('data client', () => {
  ...
  describe('createArticle', () => {
    ...
    it('creates the resource', async () => {
      ...
      expect(client.article.create).toHaveBeenCalledWith({
        data: { userId, ...attrs }
      })
    })
    ...
    describe('when it fails', () => {
      ...
      it('throws the error', () => {
        return expect(() => sut.createArticle(userId, attrs)).rejects.toEqual(
          error
        )
      })
    })
  ...
  describe('createDigest', () => {
    ...
    describe('when it fails to create the digest', () => {
      ...
      it('throws the error', () => {
        return expect(() => sut.createDigest(userId, articles)).rejects.toEqual(
          error
        )
      })
    })
